...
prompt='''现在是一个论文搜索引擎助手，现在用户给定了一个论文搜索的query，你需要帮我理解和改写该query，我们搜索引擎支持基于关键字的论文搜索、论文发布机构/学校/公司搜索、发布日期搜索。因此你首先帮我分析用户的搜索意图，>然后再帮我改写query。
#你的任务
...
prompt_final = prompt.format(example=example_str, query=user_query)
print(prompt_final)